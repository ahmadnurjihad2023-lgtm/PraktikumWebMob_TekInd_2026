...
const teksStatus = statusIndicator.querySelector("strong"); //mengambil elemen <strong> didalam alert
...
btnStart.addEventlistener("click", function () {
  //ubah ui status
  statusIndicator.className = "alert alert-succes"; // Ganti class Bootstrap (Hijau)
